...
public class PrincipalMonitorFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalMonitorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
